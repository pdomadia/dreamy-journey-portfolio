...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-20 md:py-28 bg-forest-dark text-earthy-light relative">
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_50%,rgba(124,148,115,0.2),transparent_60%)]"></div>
      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center reveal">
          <span className="inline-block text-sm md:text-base font-medium text-forest-light bg-forest-light/20 px-3 py-1 rounded-full mb-4">
            Let's Connect
          </span>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-5 reveal reveal-delay-1">
            <a 
              ...
              className="flex items-center gap-2 bg-[#7C9473] hover:bg-forest-light text-white px-6 py-3 rounded-md transition-colors duration-300 w-full md:w-auto justify-center"
            >
              <Mail size={18} />
